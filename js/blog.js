//Populate array (if not existing) when page loads
...
//Use localstorage array to list objects on page
function listPosts() {
...
//Takes in user input (title) to delete post object
function del() {
...
//Passes in object ID so it is accessible in edit()
function editDiag(id) {
    document.getElementById("editdiag").showModal();
    document.getElementById("editok").value = id;
}

//Uses object ID (arbitrary) to identify object and make changes to its properties
function edit(value) {
